...
![alt text for screen readers](https://github.com/omerkolcak/Machine-Learning-Algorithms-from-Scratch/tree/main/Regression/1-LinearRegression/images/gradient-descend.png?raw=true "Gradient Descend")
